...
from dp_cgans.ontozsl_data_sampler import OntoZSLDataSampler
...
class OntoZSLCGANSynthesizer(BaseSynthesizer):
    ...
    def fit(self, train_data, discrete_columns=tuple(), epochs=None):
        ...
        self._data_sampler = OntoZSLDataSampler(
            train_data,
            rds,
    ...
    def sample(self, n, unseen_rds=[], sort=True, condition_column=None, condition_value=None):
